              ...
              <ul class="navbar-nav" id="navbar-nav">
                  ...
                  <li class="nav-item">
                      ...
                      <div class="collapse menu-dropdown" id="sidebarDashboards">
                          <ul class="nav nav-sm flex-column">
                              ...
                              <li class="nav-item">
                                  <a href="{{ url('dashboard') }}" class="nav-link" data-key="t-dashboard">
                                      {{-- <a href="/" class="nav-link" data-key="t-crm"> --}}
                                      CRM
                                  </a>
                              </li>
                              <li class="nav-item">
                  ...
                  <li class="nav-item">
                      ...
                      <div class="collapse menu-dropdown" id="sidebarPages">
                          <ul class="nav nav-sm flex-column">
                              <li class="nav-item">
                                  {{-- <a href="role" class="nav-link" data-key="t-role"> --}}
                                  <a href="{{ url('role') }}" class="nav-link" data-key="t-role">
                                      {{-- <a href="{{ route('role.index') }}" class="nav-link" data-key="t-role"> --}}
                                      Role
                                  </a>
                              </li>
                              <li class="nav-item">
