        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xxl-3 col-md-6">
                    <x-card.card-role color="warning" />
                    <!--end card-->
                </div>
                <!--end col-->
                <div class="col-xxl-3 col-md-6">
                    <x-card.card-role color="danger" />
                    <!--end card-->
                </div>
                <!--end col-->
                <div class="col-xxl-3 col-md-6">
                    <x-card.card-role color="primary" />
                    <!--end card-->
                </div>
                <!--end col-->
                <div class="col-xxl-3 col-md-6">
                    <x-card.card-role color="success" />
                    <!--end card-->
                </div>
                <!--end col-->
                <div class="col-xxl-3 col-md-6">
            ...
            <div class="row align-items-center mb-4 g-3">
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="d-flex gap-2">
                        <a href="javascript:void(0);" class="btn btn-info">Deposit</a>
